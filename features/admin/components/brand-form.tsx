          ...
          <div className="flex gap-2">
            ...
            */}
            <input
              ...
              className="h-11 w-14 shrink-0 rounded-[--radius-control] border border-border bg-surface p-1"
            />
            <input
              id="accentColor"
              name="accentColor"
              ...
              dir="ltr"
              className="h-11 w-full rounded-[--radius-control] border border-border bg-surface px-3 text-sm text-ink numeric transition-colors hover:border-border-strong focus-visible:border-primary"
            />
          </div>
        </div>
      </FormSection>
